...
\input{./econtexRoot}
\externaldocument{\LaTeXGenerated/ProjectABM} % Get xrefs -- esp to appendix -- from main file; only works properly if main file has already been compiled;
...
\subfile{\ApndxDir/ApndxQuestionnaire.tex}
\clearpage
\subfile{\ApndxDir/ApndxRegTables.tex}
...
%\pagebreak\bibliography{\econtexRoot/\texname,\econtexBib}
