\begin{table}[ht!] \centering
	...
	\caption{Regression Table: Principal Component of Reason for Non Participation and Demographics (Parsimonious model) \label{tab:reg_pca_nopart_dem_pars}}
	\resizebox{\textwidth}{!}{%
		\begin{threeparttable}
			\begin{tabular}{L{4cm}p{1cm}C{3cm}p{1cm}C{3cm}p{1cm}C{3cm}}%{l*{6}c}
				\hline\hline
				\input{\TableDir/regression_pca_nopart_dem_pars_input.tex}
				\hline\hline
			\end{tabular}
